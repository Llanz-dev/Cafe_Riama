...
urlpatterns = [
    ...
    path('product-detail/starters/<slug:item_slug>/', views.detail_starters, name='starters'),
    path('product-detail/silog-meals/<slug:item_slug>/', views.detail_starters, name='silog-meals'),
    path('product-detail/burger-fries/<slug:item_slug>/', views.detail_starters, name='burger-fries'),
    path('update/caffeinated/<slug:item_slug>/<int:order_item_id>/', views.caffeinated_update, name='caffeinated-update'),
    path('update/starters/<slug:item_slug>/<int:order_item_id>/', views.starters_update, name='starters-update'),
    path('update/silog-meals/<slug:item_slug>/<int:order_item_id>/', views.starters_update, name='silog-update'),
    path('update/burger-update/<slug:item_slug>/<int:order_item_id>/', views.starters_update, name='burger-update'),
