...
class OrderItem(models.Model):
    ...
    milk = models.PositiveSmallIntegerField(blank=True, null=True)
    whip_cream = models.PositiveSmallIntegerField(blank=True, null=True)
    syrup_pump = models.PositiveSmallIntegerField(blank=True, null=True)
    espresso_shot = models.PositiveSmallIntegerField(blank=True, null=True)
